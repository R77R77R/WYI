...
\section{Frontend Logic (Vue.js)}
The frontend uses reactive states to manage user reviews of extracted data. Components ensure data integrity during the review process through standard Vue 3 \texttt{v-model} bindings.
