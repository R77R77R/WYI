...
BEGIN
    ...
    CREATE TABLE kernel_utilbill ([ID] BIGINT NOT NULL
        ...
        ,[Updatedat] BIGINT NOT NULL
        ,[Sort] BIGINT NOT NULL,
        [ShownProvider] NVARCHAR(MAX)
        ,[ShownUnitNum] NVARCHAR(5) COLLATE Chinese_PRC_CI_AS
        ,[ShownAcctNum] NVARCHAR(MAX)
        ,[ShownAcctName] NVARCHAR(MAX)
        ,[ShownAddr] NVARCHAR(MAX)
        ,[ShownTown] NVARCHAR(MAX)
        ,[ShownState] NVARCHAR(2) COLLATE Chinese_PRC_CI_AS
        ,[ShownZip] NVARCHAR(10) COLLATE Chinese_PRC_CI_AS
        ,[Cat] BIGINT
        ,[Provider] BIGINT
        ,[Owner] BIGINT
        ,[Unit] BIGINT
...
IF EXISTS(SELECT * FROM SYSCOLUMNS WHERE id=object_id('kernel_utilbill') AND name='ShownProvider')
    BEGIN
     ALTER TABLE kernel_utilbill ALTER COLUMN [ShownProvider] NVARCHAR(MAX)
    END
ELSE
    BEGIN
    DECLARE @sql_add_kernel_utilbill_ShownProvider NVARCHAR(MAX);
    SET @sql_add_kernel_utilbill_ShownProvider = 'ALTER TABLE kernel_utilbill ADD [ShownProvider] NVARCHAR(MAX)'
    EXEC sp_executesql @sql_add_kernel_utilbill_ShownProvider
    END


IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_kernel_utilbillShownProvider')
    BEGIN
    ALTER TABLE kernel_utilbill DROP  CONSTRAINT [Constraint_kernel_utilbillShownProvider]
    END

IF EXISTS(SELECT * FROM SYSINDEXES WHERE name='UniqueNonclustered_kernel_utilbillShownProvider')
    BEGIN
    ALTER TABLE kernel_utilbill DROP  CONSTRAINT [UniqueNonclustered_kernel_utilbillShownProvider]
    END
...
IF EXISTS(SELECT * FROM SYSCOLUMNS WHERE id=object_id('kernel_utilbill') AND name='ShownUnitNum')
    BEGIN
     ALTER TABLE kernel_utilbill ALTER COLUMN [ShownUnitNum] NVARCHAR(5) COLLATE Chinese_PRC_CI_AS
    END
ELSE
    BEGIN
    DECLARE @sql_add_kernel_utilbill_ShownUnitNum NVARCHAR(MAX);
    SET @sql_add_kernel_utilbill_ShownUnitNum = 'ALTER TABLE kernel_utilbill ADD [ShownUnitNum] NVARCHAR(5) COLLATE Chinese_PRC_CI_AS'
    EXEC sp_executesql @sql_add_kernel_utilbill_ShownUnitNum
    END


IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_kernel_utilbillShownUnitNum')
    BEGIN
    ALTER TABLE kernel_utilbill DROP  CONSTRAINT [Constraint_kernel_utilbillShownUnitNum]
    END

IF EXISTS(SELECT * FROM SYSINDEXES WHERE name='UniqueNonclustered_kernel_utilbillShownUnitNum')
    BEGIN
    ALTER TABLE kernel_utilbill DROP  CONSTRAINT [UniqueNonclustered_kernel_utilbillShownUnitNum]
    END
...
IF EXISTS(SELECT * FROM SYSCOLUMNS WHERE id=object_id('kernel_utilbill') AND name='ShownAcctNum')
    BEGIN
     ALTER TABLE kernel_utilbill ALTER COLUMN [ShownAcctNum] NVARCHAR(MAX)
    END
ELSE
    BEGIN
    DECLARE @sql_add_kernel_utilbill_ShownAcctNum NVARCHAR(MAX);
    SET @sql_add_kernel_utilbill_ShownAcctNum = 'ALTER TABLE kernel_utilbill ADD [ShownAcctNum] NVARCHAR(MAX)'
    EXEC sp_executesql @sql_add_kernel_utilbill_ShownAcctNum
    END


IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_kernel_utilbillShownAcctNum')
    BEGIN
    ALTER TABLE kernel_utilbill DROP  CONSTRAINT [Constraint_kernel_utilbillShownAcctNum]
    END

IF EXISTS(SELECT * FROM SYSINDEXES WHERE name='UniqueNonclustered_kernel_utilbillShownAcctNum')
    BEGIN
    ALTER TABLE kernel_utilbill DROP  CONSTRAINT [UniqueNonclustered_kernel_utilbillShownAcctNum]
    END
...
IF EXISTS(SELECT * FROM SYSCOLUMNS WHERE id=object_id('kernel_utilbill') AND name='ShownAcctName')
    BEGIN
     ALTER TABLE kernel_utilbill ALTER COLUMN [ShownAcctName] NVARCHAR(MAX)
    END
ELSE
    BEGIN
    DECLARE @sql_add_kernel_utilbill_ShownAcctName NVARCHAR(MAX);
    SET @sql_add_kernel_utilbill_ShownAcctName = 'ALTER TABLE kernel_utilbill ADD [ShownAcctName] NVARCHAR(MAX)'
    EXEC sp_executesql @sql_add_kernel_utilbill_ShownAcctName
    END


IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_kernel_utilbillShownAcctName')
    BEGIN
    ALTER TABLE kernel_utilbill DROP  CONSTRAINT [Constraint_kernel_utilbillShownAcctName]
    END

IF EXISTS(SELECT * FROM SYSINDEXES WHERE name='UniqueNonclustered_kernel_utilbillShownAcctName')
    BEGIN
    ALTER TABLE kernel_utilbill DROP  CONSTRAINT [UniqueNonclustered_kernel_utilbillShownAcctName]
    END
...
IF EXISTS(SELECT * FROM SYSCOLUMNS WHERE id=object_id('kernel_utilbill') AND name='ShownAddr')
    BEGIN
     ALTER TABLE kernel_utilbill ALTER COLUMN [ShownAddr] NVARCHAR(MAX)
    END
ELSE
    BEGIN
    DECLARE @sql_add_kernel_utilbill_ShownAddr NVARCHAR(MAX);
    SET @sql_add_kernel_utilbill_ShownAddr = 'ALTER TABLE kernel_utilbill ADD [ShownAddr] NVARCHAR(MAX)'
    EXEC sp_executesql @sql_add_kernel_utilbill_ShownAddr
    END


IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_kernel_utilbillShownAddr')
    BEGIN
    ALTER TABLE kernel_utilbill DROP  CONSTRAINT [Constraint_kernel_utilbillShownAddr]
    END

IF EXISTS(SELECT * FROM SYSINDEXES WHERE name='UniqueNonclustered_kernel_utilbillShownAddr')
    BEGIN
    ALTER TABLE kernel_utilbill DROP  CONSTRAINT [UniqueNonclustered_kernel_utilbillShownAddr]
    END
...
IF EXISTS(SELECT * FROM SYSCOLUMNS WHERE id=object_id('kernel_utilbill') AND name='ShownTown')
    BEGIN
     ALTER TABLE kernel_utilbill ALTER COLUMN [ShownTown] NVARCHAR(MAX)
    END
ELSE
    BEGIN
    DECLARE @sql_add_kernel_utilbill_ShownTown NVARCHAR(MAX);
    SET @sql_add_kernel_utilbill_ShownTown = 'ALTER TABLE kernel_utilbill ADD [ShownTown] NVARCHAR(MAX)'
    EXEC sp_executesql @sql_add_kernel_utilbill_ShownTown
    END


IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_kernel_utilbillShownTown')
    BEGIN
    ALTER TABLE kernel_utilbill DROP  CONSTRAINT [Constraint_kernel_utilbillShownTown]
    END

IF EXISTS(SELECT * FROM SYSINDEXES WHERE name='UniqueNonclustered_kernel_utilbillShownTown')
    BEGIN
    ALTER TABLE kernel_utilbill DROP  CONSTRAINT [UniqueNonclustered_kernel_utilbillShownTown]
    END
...
IF EXISTS(SELECT * FROM SYSCOLUMNS WHERE id=object_id('kernel_utilbill') AND name='ShownState')
    BEGIN
     ALTER TABLE kernel_utilbill ALTER COLUMN [ShownState] NVARCHAR(2) COLLATE Chinese_PRC_CI_AS
    END
ELSE
    BEGIN
    DECLARE @sql_add_kernel_utilbill_ShownState NVARCHAR(MAX);
    SET @sql_add_kernel_utilbill_ShownState = 'ALTER TABLE kernel_utilbill ADD [ShownState] NVARCHAR(2) COLLATE Chinese_PRC_CI_AS'
    EXEC sp_executesql @sql_add_kernel_utilbill_ShownState
    END


IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_kernel_utilbillShownState')
    BEGIN
    ALTER TABLE kernel_utilbill DROP  CONSTRAINT [Constraint_kernel_utilbillShownState]
    END

IF EXISTS(SELECT * FROM SYSINDEXES WHERE name='UniqueNonclustered_kernel_utilbillShownState')
    BEGIN
    ALTER TABLE kernel_utilbill DROP  CONSTRAINT [UniqueNonclustered_kernel_utilbillShownState]
    END
...
IF EXISTS(SELECT * FROM SYSCOLUMNS WHERE id=object_id('kernel_utilbill') AND name='ShownZip')
    BEGIN
     ALTER TABLE kernel_utilbill ALTER COLUMN [ShownZip] NVARCHAR(10) COLLATE Chinese_PRC_CI_AS
    END
ELSE
    BEGIN
    DECLARE @sql_add_kernel_utilbill_ShownZip NVARCHAR(MAX);
    SET @sql_add_kernel_utilbill_ShownZip = 'ALTER TABLE kernel_utilbill ADD [ShownZip] NVARCHAR(10) COLLATE Chinese_PRC_CI_AS'
    EXEC sp_executesql @sql_add_kernel_utilbill_ShownZip
    END


IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_kernel_utilbillShownZip')
    BEGIN
    ALTER TABLE kernel_utilbill DROP  CONSTRAINT [Constraint_kernel_utilbillShownZip]
    END

IF EXISTS(SELECT * FROM SYSINDEXES WHERE name='UniqueNonclustered_kernel_utilbillShownZip')
    BEGIN
    ALTER TABLE kernel_utilbill DROP  CONSTRAINT [UniqueNonclustered_kernel_utilbillShownZip]
    END
