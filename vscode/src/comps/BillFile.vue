<template>
    ...
    <div class="h-full w-full flex flex-col p-3">
        ...
        <div class="w-[300px]" v-if="props.filex.rcd.id > 0">
            <a target="_blank" :href="'/file/' + props.filex.rcd.id">
        ...
        <div class="status-row">
            ...
            <span v-if="props.filex.uploadTask.message" class="error-detail"> - {{ props.filex.uploadTask.message
                }}</span>
        </div>
    </div>
